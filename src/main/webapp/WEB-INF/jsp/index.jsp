            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu dropdown-menu-head pull-right">
                ...
                <ul class="dropdown-list user-list">
                  <li class="new">
                    <div class="thumb"><a href=""><img src="${ctx }/static/bracket/images/photos/user1.png" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="">Draniem Daamul (@draniem)</a> <span class="badge badge-success">new</span></h5>
                    </div>
                  </li>
                  <li class="new">
                    <div class="thumb"><a href=""><img src="${ctx }/static/bracket/images/photos/user2.png" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="">Zaham Sindilmaca (@zaham)</a> <span class="badge badge-success">new</span></h5>
                    </div>
                  </li>
                  <li>
                    <div class="thumb"><a href=""><img src="${ctx }/static/bracket/images/photos/user3.png" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="">Weno Carasbong (@wenocar)</a></h5>
                    </div>
                  </li>
                  <li>
                    <div class="thumb"><a href=""><img src="${ctx }/static/bracket/images/photos/user4.png" alt="" /></a></div>
                    <div class="desc">
                      <h5><a href="">Nusja Nawancali (@nusja)</a></h5>
                    </div>
                  </li>
                  <li>
                    <div class="thumb"><a href=""><img src="${ctx }/static/bracket/images/photos/user5.png" alt="" /></a></div>
                    <div class="desc">
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu dropdown-menu-head pull-right">
                ...
                <ul class="dropdown-list gen-list">
                  <li class="new">
                    <a href="">
                    <span class="thumb"><img src="${ctx }/static/bracket/images/photos/user1.png" alt="" /></span>
                    <span class="desc">
                  ...
                  <li>
                    <a href="">
                    <span class="thumb"><img src="${ctx }/static/bracket/images/photos/user2.png" alt="" /></span>
                    <span class="desc">
                  ...
                  <li>
                    <a href="">
                    <span class="thumb"><img src="${ctx }/static/bracket/images/photos/user3.png" alt="" /></span>
                    <span class="desc">
                  ...
                  <li>
                    <a href="">
                    <span class="thumb"><img src="${ctx }/static/bracket/images/photos/user4.png" alt="" /></span>
                    <span class="desc">
                  ...
                  <li>
                    <a href="">
                    <span class="thumb"><img src="${ctx }/static/bracket/images/photos/user5.png" alt="" /></span>
                    <span class="desc">
        ...
        <div class="tab-pane active" id="rp-alluser">
            ...
            <ul class="chatuserlist">
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx }/static/bracket/images/photos/userprofile.png" class="media-object">
                        </a>
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx }/static/bracket/images/photos/user1.png" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx }/static/bracket/images/photos/user2.png" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx }/static/bracket/images/photos/user3.png" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx }/static/bracket/images/photos/user4.png" class="media-object">
                        </a>
                        <div class="media-body">
            ...
            <ul class="chatuserlist">
                <li>
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx }/static/bracket/images/photos/user5.png" class="media-object">
                        </a>
                        <div class="media-body">
                            <strong>Eileen Sideways</strong>
                            <small>Los Angeles, CA</small>
